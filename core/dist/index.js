...
const getFontSizeValue = (theme, size) => {
    const fontSizeMap = {
...
const generateComponentClasses = (baseClasses, variant = 'primary', size = 'md', disabled = false, loading = false, customClasses) => {
...
const Button = React.forwardRef(({ children, className, size = 'md', variant = 'primary', disabled = false, loading = false, fullWidth = false, asChild = false, ...props }, ref) => {
    const baseClasses = `rtc-button ${fullWidth ? 'w-full' : ''}`;
    const componentClasses = generateComponentClasses(baseClasses, variant, size, disabled, loading, className);
    ...
    return (jsxRuntime.jsxs("button", { ref: ref, className: componentClasses, disabled: disabled || loading, ...props, children: [loading && (jsxRuntime.jsxs("svg", { className: "mr-2 h-4 w-4 animate-spin", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", children: [jsxRuntime.jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }), jsxRuntime.jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })] })), children] }));
});
Button.displayName = 'Button';

const Input = React.forwardRef(({ className, size = 'md', variant = 'primary', disabled = false, label, helperText, error, leftIcon, rightIcon, fullWidth = false, id, ...props }, ref) => {
    const inputId = id || `input-${Math.random().toString(36).substr(2, 9)}`;
    const hasError = Boolean(error);
    const baseClasses = `rtc-input ${fullWidth ? 'w-full' : ''} ${hasError ? 'border-red-500 focus-visible:ring-red-500' : ''}`;
    const componentClasses = generateComponentClasses(baseClasses, variant, size, disabled, false, className);
    const containerClasses = `${fullWidth ? 'w-full' : ''} ${className ? 'space-y-2' : ''}`;
    return (jsxRuntime.jsxs("div", { className: containerClasses, children: [label && (jsxRuntime.jsx("label", { htmlFor: inputId, className: `block text-sm font-medium ${hasError ? 'text-red-600' : 'text-foreground'}`, children: label })), jsxRuntime.jsxs("div", { className: "relative", children: [leftIcon && (jsxRuntime.jsx("div", { className: "absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none", children: jsxRuntime.jsx("div", { className: `h-4 w-4 ${hasError ? 'text-red-500' : 'text-muted-foreground'}`, children: leftIcon }) })), jsxRuntime.jsx("input", { ref: ref, id: inputId, className: `${componentClasses} ${leftIcon ? 'pl-10' : ''} ${rightIcon ? 'pr-10' : ''}`, disabled: disabled, ...props }), rightIcon && (jsxRuntime.jsx("div", { className: "absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none", children: jsxRuntime.jsx("div", { className: `h-4 w-4 ${hasError ? 'text-red-500' : 'text-muted-foreground'}`, children: rightIcon }) }))] }), (helperText || error) && (jsxRuntime.jsx("p", { className: `text-sm ${hasError ? 'text-red-600' : 'text-muted-foreground'}`, children: error || helperText }))] }));
});
Input.displayName = 'Input';

const Card = React.forwardRef(({ children, className, size = 'md', variant = 'primary', padding = true, shadow = 'sm', ...props }, ref) => {
    const baseClasses = `rtc-card shadow-${shadow} ${padding ? 'p-6' : ''}`;
    const componentClasses = generateComponentClasses(baseClasses, variant, size, false, false, className);
    return (jsxRuntime.jsx("div", { ref: ref, className: componentClasses, ...props, children: children }));
});
const CardHeader = React.forwardRef(({ children, className, ...props }, ref) => {
    return (jsxRuntime.jsx("div", { ref: ref, className: `rtc-card-header ${className || ''}`, ...props, children: children }));
});
const CardTitle = React.forwardRef(({ children, className, as: Component = 'h3', ...props }, ref) => {
    return (jsxRuntime.jsx(Component, { ref: ref, className: `rtc-card-title ${className || ''}`, ...props, children: children }));
});
const CardDescription = React.forwardRef(({ children, className, ...props }, ref) => {
    return (jsxRuntime.jsx("p", { ref: ref, className: `rtc-card-description ${className || ''}`, ...props, children: children }));
});
const CardContent = React.forwardRef(({ children, className, ...props }, ref) => {
    return (jsxRuntime.jsx("div", { ref: ref, className: `rtc-card-content ${className || ''}`, ...props, children: children }));
});
const CardFooter = React.forwardRef(({ children, className, ...props }, ref) => {
    return (jsxRuntime.jsx("div", { ref: ref, className: `rtc-card-footer ${className || ''}`, ...props, children: children }));
});
...
const Badge = React.forwardRef(({ children, className, size = 'md', variant = 'primary', dot = false, outline = false, ...props }, ref) => {
    const baseClasses = `rtc-badge ${outline ? 'border-current bg-transparent' : ''}`;
    const componentClasses = generateComponentClasses(baseClasses, variant, size, false, false, className);
    return (jsxRuntime.jsxs("div", { ref: ref, className: componentClasses, ...props, children: [dot && (jsxRuntime.jsx("span", { className: "mr-1 h-2 w-2 rounded-full bg-current" })), children] }));
});
Badge.displayName = 'Badge';

const Alert = React.forwardRef(({ children, className, size = 'md', variant = 'info', title, icon, closable = false, onClose, ...props }, ref) => {
    const baseClasses = 'rtc-alert';
    const componentClasses = generateComponentClasses(baseClasses, variant, size, false, false, className);
    const defaultIcons = {
        success: (jsxRuntime.jsx("svg", { className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) })),
        warning: (jsxRuntime.jsx("svg", { className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" }) })),
        error: (jsxRuntime.jsx("svg", { className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) })),
        info: (jsxRuntime.jsx("svg", { className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" }) })),
    };
    const displayIcon = icon || (variant in defaultIcons ? defaultIcons[variant] : defaultIcons.info);
    return (jsxRuntime.jsx("div", { ref: ref, className: componentClasses, ...props, children: jsxRuntime.jsxs("div", { className: "flex", children: [displayIcon && (jsxRuntime.jsx("div", { className: "shrink-0", children: displayIcon })), jsxRuntime.jsxs("div", { className: `${displayIcon ? 'ml-3' : ''} flex-1`, children: [title && (jsxRuntime.jsx("h5", { className: "mb-1 font-medium leading-none tracking-tight", children: title })), jsxRuntime.jsx("div", { className: "text-sm [&_p]:leading-relaxed", children: children })] }), closable && onClose && (jsxRuntime.jsx("button", { onClick: onClose, className: "ml-auto -mx-1.5 -my-1.5 rounded-lg p-1.5 hover:bg-gray-100 focus:outline-hidden focus:ring-2 focus:ring-gray-400", "aria-label": "Close", children: jsxRuntime.jsx("svg", { className: "h-3 w-3", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) }))] }) }));
});
const AlertTitle = React.forwardRef(({ children, className, ...props }, ref) => {
    return (jsxRuntime.jsx("h5", { ref: ref, className: `mb-1 font-medium leading-none tracking-tight ${className || ''}`, ...props, children: children }));
});
const AlertDescription = React.forwardRef(({ children, className, ...props }, ref) => {
    return (jsxRuntime.jsx("div", { ref: ref, className: `text-sm [&_p]:leading-relaxed ${className || ''}`, ...props, children: children }));
});
Alert.displayName = 'Alert';
AlertTitle.displayName = 'AlertTitle';
AlertDescription.displayName = 'AlertDescription';

const Modal = React.forwardRef(({ children, className, size = 'md', variant = 'primary', open = false, onClose, closeOnBackdrop = true, closeOnEscape = true, showCloseButton = true, backdrop = 'blur-sm', animation = 'scale', ...props }, ref) => {
    ...
    const componentClasses = generateComponentClasses(modalClasses, variant, size, false, false, className);
    return (jsxRuntime.jsxs("div", { className: baseClasses, onClick: handleBackdropClick, children: [jsxRuntime.jsx("div", { className: `fixed inset-0 ${backdropClasses[backdrop]}` }), jsxRuntime.jsxs("div", { ref: ref, className: componentClasses, ...props, children: [showCloseButton && onClose && (jsxRuntime.jsx("button", { onClick: onClose, className: "absolute right-4 top-4 rounded-xs opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2", "aria-label": "Close", children: jsxRuntime.jsx("svg", { className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) })), children] })] }));
});
const ModalHeader = React.forwardRef(({ children, className, ...props }, ref) => {
    return (jsxRuntime.jsx("div", { ref: ref, className: `flex flex-col space-y-1.5 p-6 ${className || ''}`, ...props, children: children }));
});
const ModalTitle = React.forwardRef(({ children, className, as: Component = 'h2', ...props }, ref) => {
    return (jsxRuntime.jsx(Component, { ref: ref, className: `text-lg font-semibold leading-none tracking-tight ${className || ''}`, ...props, children: children }));
});
const ModalContent = React.forwardRef(({ children, className, ...props }, ref) => {
    return (jsxRuntime.jsx("div", { ref: ref, className: `p-6 pt-0 ${className || ''}`, ...props, children: children }));
});
const ModalFooter = React.forwardRef(({ children, className, ...props }, ref) => {
    return (jsxRuntime.jsx("div", { ref: ref, className: `flex items-center justify-end space-x-2 p-6 pt-0 ${className || ''}`, ...props, children: children }));
});
...
const Spinner = React.forwardRef(({ className, size = 'md', variant = 'primary', speed = 'normal', thickness = 'normal', ...props }, ref) => {
    const sizeClasses = {
        xs: 'h-3 w-3',
        sm: 'h-4 w-4',
        md: 'h-6 w-6',
    ...
    const componentClasses = generateComponentClasses(baseClasses, variant, size, false, false, className);
    return (jsxRuntime.jsx("div", { ref: ref, className: componentClasses, ...props, children: jsxRuntime.jsxs("svg", { className: `${sizeClasses[size]} ${thicknessClasses[thickness]}`, xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", children: [jsxRuntime.jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor" }), jsxRuntime.jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })] }) }));
});
Spinner.displayName = 'Spinner';

const Toggle = React.forwardRef(({ className, size = 'md', variant = 'primary', disabled = false, label, description, checked, onCheckedChange, onChange, id, ...props }, ref) => {
    ...
    `;
    const componentClasses = generateComponentClasses(baseToggleClasses, variant, size, disabled, false, className);
    return (jsxRuntime.jsxs("div", { className: "flex items-center", children: [jsxRuntime.jsxs("div", { className: "flex items-center", children: [jsxRuntime.jsx("input", { ref: ref, type: "checkbox", id: toggleId, className: "sr-only peer", checked: checked, onChange: handleChange, disabled: disabled, ...props }), jsxRuntime.jsx("label", { htmlFor: toggleId, className: componentClasses, children: jsxRuntime.jsx("span", { className: thumbClasses }) })] }), (label || description) && (jsxRuntime.jsxs("div", { className: "ml-3", children: [label && (jsxRuntime.jsx("label", { htmlFor: toggleId, className: `text-sm font-medium cursor-pointer ${disabled ? 'text-secondary-400' : 'text-foreground'}`, children: label })), description && (jsxRuntime.jsx("p", { className: `text-sm ${disabled ? 'text-secondary-400' : 'text-secondary-600'}`, children: description }))] }))] }));
});
...
const AuthProvider = ({ children, config }) => {
    ...
    // Storage utilities
    const setStorageItem = React.useCallback((key, value) => {
        try {
    ...
    const getStorageItem = React.useCallback((key) => {
        try {
            if (mergedConfig.tokenStorage.storageType === "cookie" && storageManager) {
    ...
    const removeStorageItem = React.useCallback((key) => {
        try {
            if (mergedConfig.tokenStorage.storageType === "cookie" && storageManager) {
    ...
    // Token management
    const saveTokens = React.useCallback((tokens) => {
    ...
    // User management
    const saveUser = React.useCallback((user) => {
    ...
    const hasAnyRole = React.useCallback((roleNames) => {
        return roleNames.some((roleName) => hasRole(roleName));
    }, [hasRole]);
    const hasAllRoles = React.useCallback((roleNames) => {
        return roleNames.every((roleName) => hasRole(roleName));
    }, [hasRole]);
    const hasPermission = React.useCallback((resource, action) => {
    ...
    // Auto-refresh token
    React.useEffect(() => {
        if (!mergedConfig.autoRefresh || !state.tokens?.accessToken)
            return;
...
const useAuthGuard = (options = {}) => {
    const { requireAuth = true, requiredRoles = [], requiredPermissions = [], redirectTo, } = options;
    const auth = useAuth();
    React.useEffect(() => {
...
const useRequireRoles = (roles, redirectTo) => {
    return useAuthGuard({ requireAuth: true, requiredRoles: roles, redirectTo });
};
const useRequirePermissions = (permissions, redirectTo) => {
...
const ProtectedRoute = ({ children, fallback, loadingComponent, unauthorizedComponent, ...guardOptions }) => {
    const { isAuthorized, isLoading } = useAuthGuard(guardOptions);
    // Show loading state
    if (isLoading) {
        return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: loadingComponent || (jsxRuntime.jsx("div", { className: "flex items-center justify-center min-h-screen", children: jsxRuntime.jsxs("div", { className: "text-center space-y-4", children: [jsxRuntime.jsx(Spinner, { size: "lg", variant: "primary" }), jsxRuntime.jsx("p", { className: "text-muted-foreground", children: "Checking authentication..." })] }) })) }));
    }
    // Show unauthorized state
    if (!isAuthorized) {
        return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: unauthorizedComponent || fallback || (jsxRuntime.jsx("div", { className: "flex items-center justify-center min-h-screen p-4", children: jsxRuntime.jsxs(Alert, { variant: "error", className: "max-w-md", children: [jsxRuntime.jsx(AlertTitle, { children: "Access Denied" }), jsxRuntime.jsx(AlertDescription, { children: "You don't have permission to access this page. Please contact your administrator if you believe this is an error." })] }) })) }));
    }
    // Render protected content
    return jsxRuntime.jsx(jsxRuntime.Fragment, { children: children });
};
const RequireAuth = ({ children, fallback, redirectTo }) => {
    return (jsxRuntime.jsx(ProtectedRoute, { requireAuth: true, redirectTo: redirectTo, fallback: fallback, children: children }));
};
const RequireRole = ({ children, roles, fallback, redirectTo }) => {
    return (jsxRuntime.jsx(ProtectedRoute, { requireAuth: true, requiredRoles: roles, redirectTo: redirectTo, fallback: fallback, children: children }));
};
const RequirePermission = ({ children, permissions, fallback, redirectTo }) => {
    return (jsxRuntime.jsx(ProtectedRoute, { requireAuth: true, requiredPermissions: permissions, redirectTo: redirectTo, fallback: fallback, children: children }));
};

function RootLayout({ children, }) {
    return (jsxRuntime.jsxs("html", { className: `font-reddit`, lang: "en", suppressHydrationWarning: true, children: [jsxRuntime.jsx("head", {}), jsxRuntime.jsx("body", { className: "font-reddit antialiased bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400", children: children })] }));
}
...
const createCustomTheme = (customizations) => {
...
const ThemeProvider = ({ children, initialTheme, enableSystemTheme = true, storageKey = 'react-theme-components-theme', }) => {
...
const useThemeColors = () => {
    ...
    return React.useMemo(() => ({
        ...
        getColor: (variant, shade = '500') => getColorValue(theme, variant, shade),
    }), [theme.colors]);
};
const useThemeSpacing = () => {
    ...
    return React.useMemo(() => ({
        ...theme.spacing,
        getSize: (size) => getSizeValue(theme, size),
    }), [theme.spacing]);
};
const useThemeTypography = () => {
    const { theme } = useTheme();
    return React.useMemo(() => ({
        ...theme.typography,
        getFontSize: (size) => getFontSizeValue(theme, size),
    }), [theme.typography]);
};
const useCSSVariables = () => {
    const { theme } = useTheme();
    return React.useMemo(() => createCSSVariables(theme), [theme]);
};
...
exports.applyThemeToElement = applyThemeToElement;
...
exports.useRequirePermissions = useRequirePermissions;
exports.useRequireRoles = useRequireRoles;
...
exports.useThemeTypography = useThemeTypography;
