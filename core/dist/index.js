...
function RootLayout({ children }) {
    return (require$$1.jsxs("html", { className: `font-reddit`, lang: "en", suppressHydrationWarning: true, children: [require$$1.jsx("head", {}), require$$1.jsx("body", { className: "font-reddit antialiased bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400", "cz-shortcut-listen": "true", children: require$$1.jsx("div", { className: "flex flex-col h-[100vh]", children: require$$1.jsx(J$2, { attribute: "class", disableTransitionOnChange: true, children: children }) }) })] }));
}
