...
function Sidebar({ variant = "v2", menuItems, logoLabel, logoUrl, }) {
    ...
    return (require$$1.jsxs("div", { className: `min-w-fit  ${sidebarExpanded ? "sidebar-expanded" : ""}`, children: [require$$1.jsx("div", { className: `fixed inset-0 bg-gray-900/30 z-40 lg:hidden lg:z-auto transition-opacity duration-200 ${sidebarOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`, "aria-hidden": "true" }), require$$1.jsxs("div", { id: "sidebar", ref: sidebar, className: `flex lg:flex! flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-[100dvh] overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:w-64! shrink-0 bg-white dark:bg-gray-800 p-4 transition-all duration-200 ease-in-out  ${sidebarOpen ? "translate-x-0" : "-translate-x-64"} ${variant === "v2"
                    ? "border-r border-gray-200 dark:border-gray-700/60"
                    : "rounded-r-2xl shadow-xs"} `, children: [require$$1.jsxs("div", { className: "flex justify-center mb-5 pr-3 sm:px-2", children: [require$$1.jsxs("button", { className: "lg:hidden text-gray-500 hover:text-gray-400", onClick: () => setSidebarOpen(!sidebarOpen), "aria-controls": "sidebar", "aria-expanded": sidebarOpen, children: [require$$1.jsx("span", { className: "sr-only", children: "Close sidebar" }), require$$1.jsx("svg", { className: "w-6 h-6 fill-current", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: require$$1.jsx("path", { d: "M10.7 18.7l1.4-1.4L7.8 13H20v-2H7.8l4.3-4.3-1.4-1.4L4 12z" }) })] }), require$$1.jsx(Logo, { imageUrl: logoUrl, label: logoLabel })] }), require$$1.jsx("div", { className: "space-y-0", children: require$$1.jsxs("div", { children: [require$$1.jsx("h3", { className: "text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3", children: require$$1.jsx("span", { className: "hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6", "aria-hidden": "true", children: "\u2022\u2022\u2022" }) }), require$$1.jsx("ul", { className: "mt-3", children: menuItems?.map((menu) => {
                                        ...
                                        return (require$$1.jsx(SidebarLinkGroup, { open: isMenuActive, children: (handleClick, open) => {
                                                ...
                                                return (require$$1.jsxs(require$$1.Fragment, { children: [require$$1.jsx(Wrapper, { ...(menu?.href ? { href: menu?.href } : {}), 
                                                            // href="#0"
                                                            className: `block cursor-pointer text-gray-800 dark:text-gray-100 truncate transition ${isMenuActive
                                                                ...
                                                                // e.preventDefault();
                                                                handleClick();
                                                            }, children: require$$1.jsxs("div", { className: "flex items-center justify-between", children: [require$$1.jsxs("div", { className: "flex flex-1 items-center", children: [require$$1.jsx("span", { className: `shrink-0 fill-current ${isMenuActive
                                                                                    ? "text-indigo-500"
                                                                                    : "text-gray-400 dark:text-gray-500"}`, children: menu?.icon }), require$$1.jsx("span", { className: "text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200", children: menu?.label })] }), menu?.badge && (require$$1.jsx("div", { className: "flex shrink-0 ml-2", children: require$$1.jsx("span", { className: "inline-flex items-center justify-center h-5 text-xs font-medium text-white bg-indigo-500 px-2 rounded-sm", children: menu?.badge }) })), !menu?.href && (require$$1.jsx("div", { className: "flex shrink-0 ml-2", children: require$$1.jsx("svg", { className: `w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 ${open && "rotate-180"}`, viewBox: "0 0 12 12", children: require$$1.jsx("path", { d: "M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" }) }) }))] }) }), menu?.subMenu && (require$$1.jsx("div", { className: "lg:hidden lg:sidebar-expanded:block 2xl:block", children: require$$1.jsx("ul", { className: `pl-8 mt-1 ${!open && "hidden"}`, children: menu?.subMenu?.map((sub) => {
