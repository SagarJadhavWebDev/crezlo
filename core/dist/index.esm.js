...
import React, { forwardRef, useCallback, useEffect, createContext, useReducer, useContext, useState, useMemo } from 'react';
...
const Button = forwardRef(({ children, className, size = 'md', variant = 'primary', disabled = false, loading = false, fullWidth = false, asChild = false, ...props }, ref) => {
    ...
    return (jsxs("button", { ref: ref, className: componentClasses, disabled: disabled || loading, ...props, children: [loading && (jsxs("svg", { className: "mr-2 h-4 w-4 animate-spin", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", children: [jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }), jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })] })), children] }));
});
Button.displayName = 'Button';

const Input = forwardRef(({ className, size = 'md', variant = 'primary', disabled = false, label, helperText, error, leftIcon, rightIcon, fullWidth = false, id, ...props }, ref) => {
    ...
    return (jsxs("div", { className: containerClasses, children: [label && (jsx("label", { htmlFor: inputId, className: `block text-sm font-medium ${hasError ? 'text-red-600' : 'text-foreground'}`, children: label })), jsxs("div", { className: "relative", children: [leftIcon && (jsx("div", { className: "absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none", children: jsx("div", { className: `h-4 w-4 ${hasError ? 'text-red-500' : 'text-muted-foreground'}`, children: leftIcon }) })), jsx("input", { ref: ref, id: inputId, className: `${componentClasses} ${leftIcon ? 'pl-10' : ''} ${rightIcon ? 'pr-10' : ''}`, disabled: disabled, ...props }), rightIcon && (jsx("div", { className: "absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none", children: jsx("div", { className: `h-4 w-4 ${hasError ? 'text-red-500' : 'text-muted-foreground'}`, children: rightIcon }) }))] }), (helperText || error) && (jsx("p", { className: `text-sm ${hasError ? 'text-red-600' : 'text-muted-foreground'}`, children: error || helperText }))] }));
});
Input.displayName = 'Input';

const Card = forwardRef(({ children, className, size = 'md', variant = 'primary', padding = true, shadow = 'sm', ...props }, ref) => {
    ...
    return (jsx("div", { ref: ref, className: componentClasses, ...props, children: children }));
});
const CardHeader = forwardRef(({ children, className, ...props }, ref) => {
    return (jsx("div", { ref: ref, className: `rtc-card-header ${className || ''}`, ...props, children: children }));
});
const CardTitle = forwardRef(({ children, className, as: Component = 'h3', ...props }, ref) => {
    return (jsx(Component, { ref: ref, className: `rtc-card-title ${className || ''}`, ...props, children: children }));
});
const CardDescription = forwardRef(({ children, className, ...props }, ref) => {
    return (jsx("p", { ref: ref, className: `rtc-card-description ${className || ''}`, ...props, children: children }));
});
const CardContent = forwardRef(({ children, className, ...props }, ref) => {
    return (jsx("div", { ref: ref, className: `rtc-card-content ${className || ''}`, ...props, children: children }));
});
const CardFooter = forwardRef(({ children, className, ...props }, ref) => {
    return (jsx("div", { ref: ref, className: `rtc-card-footer ${className || ''}`, ...props, children: children }));
});
...
const Badge = forwardRef(({ children, className, size = 'md', variant = 'primary', dot = false, outline = false, ...props }, ref) => {
    const baseClasses = `rtc-badge ${outline ? 'border-current bg-transparent' : ''}`;
    const componentClasses = generateComponentClasses(baseClasses, variant, size, false, false, className);
    return (jsxs("div", { ref: ref, className: componentClasses, ...props, children: [dot && (jsx("span", { className: "mr-1 h-2 w-2 rounded-full bg-current" })), children] }));
});
Badge.displayName = 'Badge';

const Alert = forwardRef(({ children, className, size = 'md', variant = 'info', title, icon, closable = false, onClose, ...props }, ref) => {
    const baseClasses = 'rtc-alert';
    const componentClasses = generateComponentClasses(baseClasses, variant, size, false, false, className);
    const defaultIcons = {
        success: (jsx("svg", { className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) })),
        warning: (jsx("svg", { className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" }) })),
        error: (jsx("svg", { className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) })),
        info: (jsx("svg", { className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" }) })),
    };
    const displayIcon = icon || (variant in defaultIcons ? defaultIcons[variant] : defaultIcons.info);
    return (jsx("div", { ref: ref, className: componentClasses, ...props, children: jsxs("div", { className: "flex", children: [displayIcon && (jsx("div", { className: "shrink-0", children: displayIcon })), jsxs("div", { className: `${displayIcon ? 'ml-3' : ''} flex-1`, children: [title && (jsx("h5", { className: "mb-1 font-medium leading-none tracking-tight", children: title })), jsx("div", { className: "text-sm [&_p]:leading-relaxed", children: children })] }), closable && onClose && (jsx("button", { onClick: onClose, className: "ml-auto -mx-1.5 -my-1.5 rounded-lg p-1.5 hover:bg-gray-100 focus:outline-hidden focus:ring-2 focus:ring-gray-400", "aria-label": "Close", children: jsx("svg", { className: "h-3 w-3", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) }))] }) }));
});
const AlertTitle = forwardRef(({ children, className, ...props }, ref) => {
    return (jsx("h5", { ref: ref, className: `mb-1 font-medium leading-none tracking-tight ${className || ''}`, ...props, children: children }));
});
const AlertDescription = forwardRef(({ children, className, ...props }, ref) => {
    return (jsx("div", { ref: ref, className: `text-sm [&_p]:leading-relaxed ${className || ''}`, ...props, children: children }));
});
Alert.displayName = 'Alert';
AlertTitle.displayName = 'AlertTitle';
AlertDescription.displayName = 'AlertDescription';

const Modal = forwardRef(({ children, className, size = 'md', variant = 'primary', open = false, onClose, closeOnBackdrop = true, closeOnEscape = true, showCloseButton = true, backdrop = 'blur-sm', animation = 'scale', ...props }, ref) => {
    ...
    return (jsxs("div", { className: baseClasses, onClick: handleBackdropClick, children: [jsx("div", { className: `fixed inset-0 ${backdropClasses[backdrop]}` }), jsxs("div", { ref: ref, className: componentClasses, ...props, children: [showCloseButton && onClose && (jsx("button", { onClick: onClose, className: "absolute right-4 top-4 rounded-xs opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2", "aria-label": "Close", children: jsx("svg", { className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) })), children] })] }));
});
const ModalHeader = forwardRef(({ children, className, ...props }, ref) => {
    return (jsx("div", { ref: ref, className: `flex flex-col space-y-1.5 p-6 ${className || ''}`, ...props, children: children }));
});
...
const ModalContent = forwardRef(({ children, className, ...props }, ref) => {
    return (jsx("div", { ref: ref, className: `p-6 pt-0 ${className || ''}`, ...props, children: children }));
});
const ModalFooter = forwardRef(({ children, className, ...props }, ref) => {
    return (jsx("div", { ref: ref, className: `flex items-center justify-end space-x-2 p-6 pt-0 ${className || ''}`, ...props, children: children }));
});
...
const Spinner = forwardRef(({ className, size = 'md', variant = 'primary', speed = 'normal', thickness = 'normal', ...props }, ref) => {
    const sizeClasses = {
        xs: 'h-3 w-3',
        sm: 'h-4 w-4',
        md: 'h-6 w-6',
    ...
    const componentClasses = generateComponentClasses(baseClasses, variant, size, false, false, className);
    return (jsx("div", { ref: ref, className: componentClasses, ...props, children: jsxs("svg", { className: `${sizeClasses[size]} ${thicknessClasses[thickness]}`, xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", children: [jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor" }), jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })] }) }));
});
Spinner.displayName = 'Spinner';

const Toggle = forwardRef(({ className, size = 'md', variant = 'primary', disabled = false, label, description, checked, onCheckedChange, onChange, id, ...props }, ref) => {
    ...
    return (jsxs("div", { className: "flex items-center", children: [jsxs("div", { className: "flex items-center", children: [jsx("input", { ref: ref, type: "checkbox", id: toggleId, className: "sr-only peer", checked: checked, onChange: handleChange, disabled: disabled, ...props }), jsx("label", { htmlFor: toggleId, className: componentClasses, children: jsx("span", { className: thumbClasses }) })] }), (label || description) && (jsxs("div", { className: "ml-3", children: [label && (jsx("label", { htmlFor: toggleId, className: `text-sm font-medium cursor-pointer ${disabled ? 'text-secondary-400' : 'text-foreground'}`, children: label })), description && (jsx("p", { className: `text-sm ${disabled ? 'text-secondary-400' : 'text-secondary-600'}`, children: description }))] }))] }));
});
...
const ProtectedRoute = ({ children, fallback, loadingComponent, unauthorizedComponent, ...guardOptions }) => {
    ...
    // Show loading state
    if (isLoading) {
        return (jsx(Fragment, { children: loadingComponent || (jsx("div", { className: "flex items-center justify-center min-h-screen", children: jsxs("div", { className: "text-center space-y-4", children: [jsx(Spinner, { size: "lg", variant: "primary" }), jsx("p", { className: "text-muted-foreground", children: "Checking authentication..." })] }) })) }));
    }
    // Show unauthorized state
    if (!isAuthorized) {
        return (jsx(Fragment, { children: unauthorizedComponent || fallback || (jsx("div", { className: "flex items-center justify-center min-h-screen p-4", children: jsxs(Alert, { variant: "error", className: "max-w-md", children: [jsx(AlertTitle, { children: "Access Denied" }), jsx(AlertDescription, { children: "You don't have permission to access this page. Please contact your administrator if you believe this is an error." })] }) })) }));
    }
    // Render protected content
    return jsx(Fragment, { children: children });
};
const RequireAuth = ({ children, fallback, redirectTo }) => {
    return (jsx(ProtectedRoute, { requireAuth: true, redirectTo: redirectTo, fallback: fallback, children: children }));
};
const RequireRole = ({ children, roles, fallback, redirectTo }) => {
    return (jsx(ProtectedRoute, { requireAuth: true, requiredRoles: roles, redirectTo: redirectTo, fallback: fallback, children: children }));
};
const RequirePermission = ({ children, permissions, fallback, redirectTo }) => {
    return (jsx(ProtectedRoute, { requireAuth: true, requiredPermissions: permissions, redirectTo: redirectTo, fallback: fallback, children: children }));
};

function RootLayout({ children, }) {
    return (jsxs("html", { className: `font-reddit`, lang: "en", suppressHydrationWarning: true, children: [jsx("head", {}), jsx("body", { className: "font-reddit antialiased bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400", children: children })] }));
}
...
export { Alert, AlertDescription, AlertTitle, ApiClient, AuthContext, AuthProvider, Badge, Button, Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle, CookieManager, Input, Modal, ModalContent, ModalFooter, ModalHeader, ModalTitle, ProtectedRoute, RequireAuth, RequirePermission, RequireRole, RootLayout, Spinner, ThemeContext, ThemeProvider, Toggle, apiCall, applyThemeToElement, clearAllCookies, cookieManager, createApiClient, createCSSVariables, createCookieManager, createCustomTheme, darken, defaultDarkTheme, defaultLightTheme, generateComponentClasses, getAllCookies, getColorValue, getCookie, getCookieJSON, getFontSizeValue, getSizeValue, hasCookie, hexToRgb, isCookiesEnabled, lighten, removeCookie, rgbToHex, setCookie, setCookieJSON, useAuth, useAuthGuard, useCSSVariables, useDebounce, useLocalStorage, useMediaQuery, useOptionalAuth, useRequireAuth, useRequirePermissions, useRequireRoles, useResponsive, useTheme, useThemeColors, useThemeMode, useThemeSpacing, useThemeTypography, useToggle };
