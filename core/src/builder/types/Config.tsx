...
import { AsFieldProps, WithChildren, WithId, WithCrezloProps } from "./Utils";
...
export type CrezloComponent<Props> = (
  props: WithId<
    WithCrezloProps<{
...
> = {
  render: CrezloComponent<RenderProps>;
  preview?: Fields<FieldProps>;
  label?: string;
