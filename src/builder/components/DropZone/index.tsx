...
const DropZoneChild = ({
  ...
  const crezloProps: CrezloContext = useMemo(
    () => ({
  ...
  const defaultsProps = useMemo(
    ...
    [componentConfig?.defaultProps, item?.props, crezloProps]
  );
        ...
        componentConfig?.inline && !isInserting ? (
          <>
            <Render
              ...
              crezlo={{
                ...defaultedPropsWithSlots.crezlo,
                dragRef,
              }}
            />
          </>
  ...
  function DropZoneEditInternal(
    ...
    useEffect(() => {
      if (zoneType === "dropzone") {
        if (zoneCompound !== rootDroppableId) {
          console.warn(
            "DropZones have been deprecated in favor of slot fields and will be removed in a future version of Crezlo. Please see the migration guide: https://www.crezloeditor.com/docs/guides/migrations/dropzones-to-slots"
          );
        }
      }
    }, [zoneType]);
    ...
    return (
      <div
        ...
        data-crezlo-dropzone={zoneCompound}
        style={
          {
            ...style,
