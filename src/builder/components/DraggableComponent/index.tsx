...
export const DraggableComponent = ({
  ...
  useEffect(() => {
    ...
    if (ref.current && !permissions.drag) {
      ref.current.setAttribute("data-crezlo-disabled", "");

      return () => {
        ref.current?.removeAttribute("data-crezlo-disabled");
        cleanup();
      };
    }
  ...
  useEffect(() => {
    setPortalEl(
      iframe.enabled
        ...
        : ref.current?.closest<HTMLElement>("[data-crezlo-preview]") ??
            document.body
    );
  ...
  useEffect(() => {
    ...
    el.setAttribute("data-crezlo-component", id);
    el.setAttribute("data-crezlo-dnd", id);
    ...
    return () => {
      el.removeAttribute("data-crezlo-component");
      el.removeAttribute("data-crezlo-dnd");
