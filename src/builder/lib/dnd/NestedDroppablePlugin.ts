...
const getPointerCollisions = (
  ...
  if (elements) {
    for (let i = 0; i < elements.length; i++) {
      ...
      const dropzoneId = element.getAttribute("data-crezlo-dropzone");
      const id = element.getAttribute("data-crezlo-dnd");
      const isVoid = element.hasAttribute("data-crezlo-dnd-void");
